...
public class MetaItems {
	...
	public static void initize() {
		...
		//MinecraftForge.setToolClass(MetaItems.strangeChisel, "metaChisel", 20);
		...
		GameRegistry.addRecipe(new ItemStack(MetaBlocks.inventoryLinkBlock, 4),
				new Object[] { "iii", "isi", "iii", Character.valueOf('s'), MetaItems.strangeIngot, Character.valueOf('i'), Item.ingotIron});
