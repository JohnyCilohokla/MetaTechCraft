...
public class MetaItems {
	...
	public static void initize() {
		...
		GameRegistry.addRecipe(new ItemStack(MetaItems.strangeDust, 8), new Object[] { "rer", "gdg", "rer", Character.valueOf('r'), Item.redstone, Character.valueOf('d'), Item.diamond, Character.valueOf('g'), Block.glowStone, Character.valueOf('e'), Item.enderPearl });
