...
public class MetaDust extends ItemWithInfo {

	static final String[] DUST_NAMES = new String[] { "White", "Black", "Red", "Green", "Blue" };
	static final int DUST_NUMBER = MetaDust.DUST_NAMES.length - 1;
	...
	public void registerIcons(IIconRegister iconRegister) {
		...
		this.icons = new IIcon[MetaDust.DUST_NAMES.length];
